...
func (m *KetchupService) ListOutdated(arg0 context.Context, arg1 ...model.User) ([]model.Ketchup, error) {
	m.ctrl.T.Helper()
...
func (mr *KetchupServiceMockRecorder) ListOutdated(arg0 interface{}, arg1 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
